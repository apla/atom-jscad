...
if( window.jsDependencies == null ) {
  window.jsDependencies =  [ 'three.min.js', 'orbitcontrols.js', 'projector.js', 'canvasrenderer.js', 'jquery-2.1.3.min.js', 'csg.js', 'threecsg.js', 'openjscad.js', 'formats.js', 'main.js'];

  jsDependencies = jsDependencies.map( function( scriptName ) {
    return 'file://' + path.join( atom.packages.getLoadedPackage( 'atom-scad-preview' ).path, 'standalone', scriptName );
  });
};
