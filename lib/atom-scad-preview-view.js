  ...
  AtomScadPreviewView.prototype.loadDependencies = function () {
    ...
    async.eachSeries(jsDependencies, function (scriptName, next) {
      ...
      gProcessor.enableItems = function enableItems() {
        // console.warn('enableItems overridden');
        // this.abortbutton.style.display = 'block'; // inlilne
        // this.formatDropdown.style.display = 'block'; // inlilne
        // this.generateOutputFileButton.style.display = 'block'; // inlilne
        // this.downloadOutputFileLink.style.display = 'block'; // inlilne
        // this.parametersdiv.style.display = 'block'; // inline-block before that block
