...
describe "AtomScadPreview", ->
  [workspaceElement, activationPromise] = []

  beforeEach ->
    workspaceElement = atom.views.getView(atom.workspace)
    activationPromise = atom.packages.activatePackage('atom-scad-preview')

  describe "when the atom-scad-preview:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'atom-scad-preview:toggle'
        expect(atomScadPreviewPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'atom-scad-preview:toggle'
        expect(atomScadPreviewElement).not.toBeVisible()
